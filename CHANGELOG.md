...
- Removed the "Vote for your favorite" link from the homepage — like the song pages, `vote.html` is reachable only via its printed QR code, not linked from the site.
